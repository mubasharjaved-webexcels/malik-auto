          ...
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center text-bg-light">
              ...
              <div class="d-flex gap-2">
                ...
                <form action="<?php echo e(route('office-expense.search')); ?>" method="GET" class="d-flex align-items-left">
                  <input type="text" 
                ...
                <form id="export-form" action="<?php echo e(route('office-expenses.export')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
              ...
              <div class="table-responsive">
                <table id="expensesTable" class="table table-striped table-hover table-bordered">
                  ...
                  <tbody id="expense-table-body">
                    <?php echo $__env->make('dashboards.office_expenses.partials.office_expense_rows', ['processedExpenses' => $processedExpenses], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <th id="car-expense-grand-total">
                        <strong class="text-success">
                          $<?php echo e(number_format($processedExpenses->sum('usd_amount'), 2)); ?>
                ...
                <?php if($processedExpenses->hasPages()): ?>
                    <div class="mt-4 d-flex justify-content-center">
                        <?php echo e($processedExpenses->links('pagination::bootstrap-5')); ?>
...
$(document).ready(function() {
    ...
    //     $.ajax({
    //         url: '<?php echo e(route('office-expenses.getYards')); ?>',
    //         method: 'GET',
    ...
    function loadManagers(countryId, selector = '#assigned_manager_id', selectedManagerId = null) {
      ...
      $.ajax({
          url: '<?php echo e(url("/get-managers")); ?>/' + countryId,
          method: 'GET',
          dataType: 'json',
    ...
    $('#addExpenseForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route('office-expenses.store')); ?>',
            method: 'POST',
            data: $(this).serialize(),
            success: function(response) {
                if (response.success) {
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $.ajax({
            url: '<?php echo e(route('office-expenses.show', ':id')); ?>'.replace(':id', id),
            method: 'GET',
            success: function(response) {
                if (response.success) {
    ...
    $('#editExpenseForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route('office-expenses.update', ':id')); ?>'.replace(':id', id),
            method: 'PUT',
            data: $(this).serialize(),
            success: function(response) {
                if (response.success) {
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        if (confirm('Are you sure you want to delete this expense?')) {
            $.ajax({
                url: '<?php echo e(route('office-expenses.destroy', ':id')); ?>'.replace(':id', id),
                method: 'DELETE',
                data: {
  ...
  $(document).ready(function () {
    function applyFilters() {
      ...
      $.ajax({
        url: "<?php echo e(route('office-expenses.filter')); ?>",
        method: 'POST',
        data: {
    ...
    const managerCountryId = <?php echo json_encode(auth()->user()->country_id, 15, 512) ?>;

    if (userIsManager) {
      // $(window).on('load', function () {
        $('#country-filter').val(managerCountryId); 
        $('#manager-filter').val(<?php echo json_encode(auth()->id(), 15, 512) ?>);
          applyFilters();
      // });
    }
    ...
    $('#country-filter').change(function () {
      ...
      if (countryId) {
        $.get("<?php echo e(url('get-managers')); ?>/" + countryId, function (response) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      searchInput.addEventListener('keyup', function () {
          ...
          timer = setTimeout(function () {
              $.ajax({
                  url: "<?php echo e(route('office-expense.search')); ?>",
                  type: "GET",
...
<?php echo $__env->make('dashboards.partials.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/malikautonet/public_html/resources/views/dashboards/office_expenses/index.blade.php ENDPATH**/ ?>