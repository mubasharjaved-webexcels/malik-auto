                      ...
                      <div class="row g-4">
                        ...
                        <div class="col-md-3 col-sm-6">
                          <div class="card h-100 shadow-sm border-0 rounded-3 d-flex flex-column justify-content-between text-center">
                            <a class="text-decoration-none" href="<?php echo e($totalAssignedCars > 0 ? route('car-profiles.index', ['country_id' => $country->id]) : 'javascript:void(0)'); ?>">
                              <div class="card-body px-2">
                                <h6 class="fw-semibold text-dark mb-2"><?php echo e($country->name); ?></h6>
                                <p class="mb-1 small">Total Cars</p>
                                <h3 class="fw-bold text-primary mb-3"><?php echo e($totalAssignedCars); ?></h3>
                                <img src="<?php echo e(asset("admin-assets/images/cars/c1.png")); ?>" class="img-fluid mt-2" alt="Car1">
                              </div>
                            </a>
                          </div>
                        </div>
...
<?php /**PATH /home/malikautonet/public_html/resources/views/dashboards/manager.blade.php ENDPATH**/ ?>