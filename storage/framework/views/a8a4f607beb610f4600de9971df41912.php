        ...
        <div class="col-md-6 p-5">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="name" name="name" class="form-control" holder="Full Name" value="<?php echo e(old('name')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center mt-4 small">
                Already have an account? <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">Sign In</a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/malikautonet/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>