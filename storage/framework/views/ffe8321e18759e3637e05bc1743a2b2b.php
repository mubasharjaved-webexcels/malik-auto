                    ...
                    <div class="card">
                          ...
                          <div class="text-bg-light pt-2 px-3 pb-0 card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                              <form action="<?php echo e(route('car-profiles.search')); ?>" method="GET" class="d-flex align-items-left" style="margin-bottom: 7px;">
                                <input type="text" 
                                  id="car-search"
                                  name="search" 
                              ...
                              <a href="<?php echo e(route('car-profiles.create')); ?>" class="btn btn-primary text-white" style="margin-right: 0;border: none;padding: 9px 15px;margin-bottom: 7px;"><i class="mdi mdi-plus" style="font-size: 12px;"></i>Add New Car</a>
                              <?php endif; ?>
                            </div>
                          </div>
                      <div class="card-body">
                          ...
                          <div class="row mb-4">
                            <div class="col-md-2">
                              <select name="per_page" id="per_page" class="form-select text-dark" onchange="this.form.submit()">
                                <?php $__currentLoopData = [5, 10, 25, 50, 100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($size); ?>" <?php echo e($per_page_value == $size ? 'selected' : ''); ?>>Range - <?php echo e($size); ?></option>
                            ...
                            <div class="col-md-2 px-1">
                              <select name="country_id" id="country_id" class="form-select text-dark" onchange="this.form.submit()">
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($country->id); ?>" <?php echo e(request('country_id') == $country->id ? 'selected' : ''); ?>><?php echo e($country->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
                        
                            <div class="col-md-2 px-1">
                              <select name="assigned_manager_id" id="assigned_manager_id" class="form-select text-dark" <?php echo e(request('country_id') ? '' : 'disabled'); ?> onchange="this.form.submit()">
                                <option value="">All Managers</option>
                                <?php $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($manager->id); ?>" <?php echo e(request('assigned_manager_id') == $manager->id ? 'selected' : ''); ?>><?php echo e($manager->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
                        
                            <div class="col-md-2 px-1">
                              <select name="rec_no" id="rec_no" class="form-select text-dark" <?php echo e(request('assigned_manager_id') ? '' : 'disabled'); ?> onchange="this.form.submit()">
                                <option value="">All Rec Nos</option>
                                <?php $__currentLoopData = $recNos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recNo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($recNo); ?>" <?php echo e(request('rec_no') == $recNo ? 'selected' : ''); ?>><?php echo e($recNo); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
                            ...
                            <div class="col-md-2 px-1">
                              <select name="car_status" id="car_status" class="form-select text-dark" onchange="this.form.submit()">
                                ...
                                <?php $__currentLoopData = $carStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($status); ?>" <?php echo e(request('car_status') == $status ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-2">
                              <button id="reset-filters" class="btn btn-secondary w-100 text-white" style="height:46px;" type="button" onclick="window.location='<?php echo e(route('car-profiles.index')); ?>'">
                        ...
                        <div id="car-list">
                          <?php echo $__env->make('dashboards.car_profiles.partials.list', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                      </div> <!-- card-body -->
                    </div> <!-- card -->
                  </div> <!-- stretch-card -->
    ...
    //         const countryName = this.dataset.countryName;
      ...
      document.addEventListener('click', function (e) {
        ...
        document.getElementById('modalCountryId').value = countryId;
              ...
              // Fetch managers
              const getManagersUrl = "<?php echo e(url('/get-managers')); ?>";
      ...
      document.getElementById('transferForm').addEventListener('submit', async function (e) {
        ...
        const transferUrl = "<?php echo e(url('/car-profiles')); ?>";
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    searchInput.addEventListener('keyup', function () {
        ...
        timer = setTimeout(function () {
            $.ajax({
                url: "<?php echo e(route('car-profiles.search')); ?>",
                type: "GET",
                data: { search: searchInput.value, per_page: <?php echo e($per_page_value); ?> },
...
<?php /**PATH /home/malikautonet/public_html/resources/views/dashboards/car_profiles/index.blade.php ENDPATH**/ ?>