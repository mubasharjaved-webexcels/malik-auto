...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('admin-assets/vendors/simple-line-icons/css/simple-line-icons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('admin-assets/vendors/css/vendor.bundle.base.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('admin-assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('admin-assets/js/select.dataTables.min.css')); ?>">
      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start bg-white">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="#">
            <img src="<?php echo e(asset('admin-assets/images/admin-logo.png')); ?>" alt="Malik Auto" />
          </a>
        </div>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-top px-3">
        <h1 class="text-3xl font-light text-gray-600 mb-2">
          Welcome, <span class="font-semibold text-indigo-600"><?php echo e(Auth::user()->name); ?>!</span>
        </h1>
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="<?php echo e(asset('admin-assets/images/faces/face8.jpg')); ?>" alt="Profile image">
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <p class="mb-1 mt-3 fw-semibold"><?php echo e(Auth::user()->name); ?></p>
...
<?php /**PATH /home/malikautonet/public_html/resources/views/dashboards/partials/header.blade.php ENDPATH**/ ?>