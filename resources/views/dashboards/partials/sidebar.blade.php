<nav class="sidebar sidebar-offcanvas bg-white shadow-lg" id="sidebar">
  <ul class="nav">
    <li class="nav-item">
      <a class="nav-link border-bottom py-2" href="{{ url('dashboard') }}" style="border-radius:0;">
        <i class="mdi mdi-view-dashboard-outline me-2" style="font-size: 14px;"></i>
        <span class="menu-title">Dashboard</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link border-bottom py-2" href="{{ route('car-profiles.index') }}" style="border-radius:0;">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="expensesSubmenu">
        <ul class="nav flex-column sub-menu py-0">
          <li class="nav-item">
            <a class="nav-link" href="{{ route('car-expenses.index') }}">
              <i class="mdi mdi-car menu-icon" style="font-size: 12px;"></i>
              Car Expenses
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('office-expenses.index') }}">
    ...
    <li class="nav-item">
      <a class="nav-link border-bottom py-2" href="{{ route('users.managers') }}" style="border-radius:0;">
        <i class="mdi mdi-account-group me-2" style="font-size: 14px;"></i>
        <span class="menu-title">Managers Team</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link border-bottom py-2" href="{{ route('car_profiles.getPendingRequests') }}" style="border-radius:0;">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="accountsSubmenu"> {{-- CHANGED ID HERE --}}
        <ul class="nav flex-column sub-menu py-0">
          @unlessrole('manager')
            <li class="nav-item">
              <a class="nav-link" href="{{ route('accounts.journal-voucher') }}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('accounts.index', ['type' => 'cash']) }}">
              <i class="mdi mdi-cash menu-icon" style="font-size: 12px;"></i>
              Cash in Hand
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('accounts.profit_by_cars') }}">
              <i class="mdi mdi-car-key menu-icon" style="font-size: 12px;"></i>
              Profit by Cars
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('accounts.overall_profit_loss') }}">
    ...
    <li class="nav-item">
      <a class="nav-link border-bottom py-2" href="{{ route('currency.rates') }}" style="border-radius:0;">
