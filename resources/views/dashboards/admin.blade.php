                      ...
                      <div class="row g-3">
                        ...
                        @foreach($countries as $country)
                            <div class="col-md-3 col-sm-6">
                              ...
                              <a class="text-decoration-none" href="{{ $country->car_profiles_count != 0 ? route('car-profiles.index', ['country_id' => $country->id]) : 'javascript:void(0)' }}">
                              <div class="card-body">
                                <h6 class="fw-bold text-dark mb-2">{{ $country->name  }}</h6>
                                <p class="mb-1 small">Total Cars</p>
                                <h3 class="fw-bold text-primary mb-3">{{ $country->car_profiles_count }}</h3>
                          ...
                          <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-start">
                              ...
                              <div style="
                                  text-align: right;
                                ">
                                <h6 class="me-2 fw-bold"> Total Auction Price: ${{ $totalAuctionPrice }}</h6>
                                <h6 class="me-2 fw-bold">Total Expenses: ${{ $totalExpenses }} </h6>
                              </div>
                              ...
                              <div class="d-sm-flex align-items-center mt-1 justify-content-between">
                                <div class="d-sm-flex align-items-center mt-4 justify-content-between">
                                  ...
                                  <h2 class="me-2 fw-bold">${{ number_format($totalAuctionPrice + $totalExpenses, 2) }}</h2>
                        ...
                        <form method="GET" action="{{ route('admin.dashboard') }}">
                          <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-4 d-flex gap-2">
                              ...
                              <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary text-white mb-1 mt-1">Reset</a>
                            </div>
                          </div>
                        </form>
                      </div>
                          ...
                          <div class="card-body p-0">
                            ...
                            @else
                              <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                  @foreach ($carExpenses as $row)
                                    <tr>
                                      <td>{{ $row->country_name }}</td>
                                      <td class="text-end">${{ number_format($row->total_usd, 2) }}</td>
                                    </tr>
                                  @endforeach
                                </tbody>
                                    <tr>
                                      <td class="fw-bold">Total</td>
                                      <td class="text-end">${{ number_format($totalCarExpense, 2) }}</td>
                                    </tr>
                              </table>
                            @endif
                          </div>
                              ...
                              <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                  ...
                                  @endforeach
                                    ...
                                    <tr>
                                      <td class="fw-bold">Total</td>
                                      <td class="text-end">${{ number_format($totalOfficeExpense, 2) }}</td>
                                    </tr>
                              </table>
                            @endif
                          </div>
                          ...
                          <div class="card-body p-0">
                            ...
                            @else
                              <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                  @foreach ($soldPrices as $sold)
                                    <tr>
                                        <td>{{ $sold->country_name }}</td>
                                        <td class="text-end">
                                            {{ $sold->total_sold_price > 0 ? '$' . number_format($sold->total_sold_price, 2) : '-' }}
                                        </td>
                                    </tr>
                                  @endforeach
                                </tbody>
                                    <tr>
                                      <td class="fw-bold">Total</td>
                                      <td class="text-end">${{ number_format($totalSoldPrice, 2) }}</td>
                                    </tr>
                              </table>
                            @endif
                          </div>
                            ...
                            <table class="table table-bordered mb-0">
                              ...
                              <tbody>
                                @foreach ($countries as $country)
                                  ...
                                  <tr>
                                      <td>{{ $country->name }}</td>
                                      <td class="text-end">{{ is_numeric($bankTotal) ? number_format($bankTotal, 2) : 'N/A' }}</td>
                                      <td class="text-end">{{ is_numeric($cashTotal) ? number_format($cashTotal, 2) : 'N/A' }}</td>
                                  </tr>
                                @endforeach
                              </tbody>
                            </table>
